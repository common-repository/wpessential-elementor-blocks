...
class Modal extends Base implements Shortcodes
{
	...
	{
		return [ 'Modal', 'light-box', 'light box', 'popup', 'bootstrap', 'bootstrap-modal' ];
	}
	...
	private function modal_content ()
	{
		...
		$this->add_control(
			'wpe_st_selected_icon_type',
			[
				'label'       => esc_html__( 'Select Icon Type', 'wpessential-elementor-blocks' ),
				'type'        => Controls_Manager::CHOOSE,
				'options'     => [
					'icon'  => [
						'title' => esc_html__( 'Icon', 'wpessential-elementor-blocks' ),
						'icon'  => 'eicon-circle',
					],
					'svg'   => [
						'title' => esc_html__( 'SVG', 'wpessential-elementor-blocks' ),
						'icon'  => 'eicon-upload',
					],
					'image' => [
				...
				'default'     => 'icon', // Set default option
				'toggle'      => true,   // Allow only one option to be selected at a time
				'label_block' => false,  // Set to true if you want the label to span the whole width
			]
		);
		$this->add_control(
			...
			[
				...
				'condition'   => [
					'wpe_st_selected_icon_type' => 'icon',
		...
		$this->add_control(
			'wpe_st_selected_svg',
			[
				'label'       => esc_html__( 'SVG', 'wpessential-elementor-blocks' ),
				'type'        => Controls_Manager::ICONS,
				'default'     => [
					'value' => 'fas fa-circle',
					'library' => 'fa-solid',
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'wpe_st_selected_icon_type' => 'image',
				],
			]
		);
