...
class MasterSlider extends SliderCategory
{
	/**
	 * Set widget keywords.
	...
	{
		return [ 'slider', 'masterslider', 'layer', 'master slider' ];
	}
	...
	public function render ()
	{
		...
		echo do_shortcode( '[masterslider id="' . $settings->get( 'wpe_st_slider_list' ) . '"]' );
	}
}
